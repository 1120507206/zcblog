...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  base: '/zcblog/', // 默认'/'。如果你想将你的网站部署到如 https://foo.github.io/bar/，那么 base 应该被设置成 "/bar/",（否则页面将失去样式等文件）
  ...
  themeConfig: {
    ...
    repo: '1120507206/zcblog', // 导航栏右侧生成Github链接
    ...
    author: {
      name: 'zc', // 必需
      link: 'https://github.com/1120507206/', // 可选的
    },
